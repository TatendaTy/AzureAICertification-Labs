...
agents_client = AgentsClient(
    endpoint=project_endpoint, # type: ignore
...
with agents_client:
    ...
    priority_agent = agents_client.create_agent(
        model=model_deployment, # type: ignore
    ...
    team_agent_tool = ConnectedAgentTool(
        id=team_agent.id,
        name=team_agent_name,
        description="Determine the appropriate team for a ticket"
    )
    ...
    agents_client.delete_agent(agent_id=triage_agent.id)
    print(f'- Deleted triage agent: {triage_agent.name}')
    agents_client.delete_agent(agent_id=priority_agent.id)
    print(f'- Deleted priority agent: {priority_agent.name}')
    agents_client.delete_agent(agent_id=team_agent.id)
    print(f'- Deleted team agent: {team_agent.name}')
    agents_client.delete_agent(agent_id=effort_agent.id)
    print(f'- Deleted effort agent: {effort_agent.name}')
