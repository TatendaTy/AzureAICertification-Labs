...
with agents_client:
    ...
    # Set approval mode
    mcp_tool.set_approval_mode("never") # allow the agent to automatically invoke the MCP tools without user approval
    ...
    run = agents_client.runs.create_and_process(
        ...
        agent_id=agent.id,
        toolset=toolset
    ) # The AI Agent automatically invokes the connected MCP tools to process the prompt request.
